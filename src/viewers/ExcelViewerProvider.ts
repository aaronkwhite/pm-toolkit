...
export class ExcelViewerProvider implements vscode.CustomReadonlyEditorProvider {
  public static readonly viewType = 'pmtoolkit.xlsxViewer';

  constructor(private readonly context: vscode.ExtensionContext) {}

  public static register(context: vscode.ExtensionContext): vscode.Disposable {
    const provider = new ExcelViewerProvider(context);
    return vscode.window.registerCustomEditorProvider(
      ExcelViewerProvider.viewType,
      provider,
      {
        webviewOptions: {
  ...
  public async resolveCustomEditor(
    ...
    const scriptUri = webviewPanel.webview.asWebviewUri(
      vscode.Uri.joinPath(this.context.extensionUri, 'dist', 'webview', 'excel-viewer.js')
    );
